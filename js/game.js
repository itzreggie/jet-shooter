...
(function() {
	...
	Game.prototype = {
		...
		createGround: function () {
            ...
            var lastBackground = localStorage.getItem('lastBackground') || 'tileset_1';


            var currentBackground = (lastBackground === 'tileset_1') ? 'background_single' : 'tileset_1';


            localStorage.setItem('lastBackground', currentBackground);

            if (CONFIG.DEBUG.tileset) {
                this.map.addTilesetImage('tileset_1', 'tileset_1_debug', 24, 28, null, null, 0);
            } else {
                this.map.addTilesetImage(currentBackground, currentBackground, 24, 28, null, null, 0);
            }
